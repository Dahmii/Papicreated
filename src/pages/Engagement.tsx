...
const Engagement = () => {
  const images = portfolioImages.filter((img) => img.category === "Engagement");
    ...
    <div className="w-full">
      ...
      <section className="relative py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Engagement</h1>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Before the vows, there’s the spark — the joy, anticipation, and
              deep connection that brought you together. Our engagement sessions
              are all about celebrating your love story in an authentic,
              stylish, and meaningful way. Whether it’s a quiet moment or a
              joyful laugh, we’ll capture the essence of your journey to “I do.”
            </p>
          </motion.div>
        </div>
      </section>
