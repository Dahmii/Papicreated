...
const Portrait = () => {
  const images = portfolioImages.filter((img) => img.category === "Portrait");
    ...
    <div className="w-full">
      ...
      <section className="relative py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Portrait</h1>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Discover striking portraits that reveal personality, emotion, and
              depth. Each frame is a powerful expression of individuality —
              thoughtfully captured and artfully composed.
            </p>
          </motion.div>
        </div>
      </section>
