...
const Studio = () => {
  const images = portfolioImages.filter((img) => img.category === "Studio");
    ...
    <div className="w-full">
      ...
      <section className="relative py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Studio</h1>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Experience creativity in a controlled setting — where lighting,
              composition, and styling come together to create bold, polished,
              and timeless images.
            </p>
          </motion.div>
        </div>
