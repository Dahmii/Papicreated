...
const Family = () => {
  const images = portfolioImages.filter((img) => img.category === "Family");
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Capture the warmth, love, and connection that make your family
              unique. In a relaxed and beautifully styled setting, we create
              timeless portraits that reflect your family's bond — with
              attention to lighting, composition, and those genuine shared
