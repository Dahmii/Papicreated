...
const Events = () => {
  const images = portfolioImages.filter((img) => img.category === "Events");
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Every event is a story unfolding — laughter, tears, milestones,
              and magic. We don’t just take photos; we document the energy,
              emotion, and details that make your celebration unforgettable.
              From candid moments to grand highlights, we’re there to preserve
              it all, so you can relive the day long after it's passed.
            </p>
          </motion.div>
        </div>
      </section>
